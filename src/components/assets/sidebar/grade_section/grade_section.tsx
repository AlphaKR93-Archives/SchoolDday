...
export default function GradeSection() {
    const enabledTypes = useAppSelector(state => state.enabledDdayGrades.enabled);
    ...
    return (
        <li>
            ...
            <Slider
                name="1학년"
                enabled={enabledTypes.includes(1)}
            ...
            <Slider
                name="2학년"
                enabled={enabledTypes.includes(2)}
            ...
            <Slider
                name="3학년"
                enabled={enabledTypes.includes(3)}
